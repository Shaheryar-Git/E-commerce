	...
	return (
		<div>
			<div className="bg-gradient p-2 text-center bg-dark text-white ">
				<marquee className="mb-0 fs-6 fw-bolder ">
					🎉 Welcome To Solebazar 🎉 Free Home Delivery
				</marquee>
			</div>
			<nav
				className="navbar navbar-expand-lg p-3 bg-secondary"
				style={{ backgroundColor: "#4D4D4C", height: "100px" }}
			>
